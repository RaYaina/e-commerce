    ...
    >
      ...
      >
        ...
        <div className="flex flex-1 mt-16 overflow-hidden">
          ...
          >
            {/* 
              children est maintenant une FONCTION qui reçoit darkMode.
              Ça évite le problème de cloneElement sur <Routes> qui ne
              transmet jamais les props aux <Route> enfants.
            */}
