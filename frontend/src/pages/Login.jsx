...
export default function LoginPage() {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      // Stocker les informations utilisateur ET le token selon "Se souvenir de moi"
      if (values.remember) {
      ...
      if (error.response) {
        ...
        message.error('Impossible de contacter le serveur. Vérifiez que le backend est lancé sur le port 8081.');
      } else {
